...
class LibraryView(ft.Container):
    ...
    def load_library(self, query=""):
        ...
        for row in results:
            ...
            image_control = ft.Image(src=cover_url, width=150, height=150, fit=ft.ImageFit.COVER, border_radius=10) if cover_url else ft.Icon(ft.icons.LIBRARY_MUSIC, size=100, color=ACCENT_PRIMARY)
            ...
            # Make it clickable to open folder
